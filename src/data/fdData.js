// ── FD SAATHI — Mock FD Data (2025 realistic rates) ──

export const FD_DATA = [
  {
    id: 'suryoday-1',
...
// Maturity calculation (compound annually)
export function calcMaturity(principal, ratePercent, months) {
  const r = ratePercent / 100;
  const t = months / 12;
  return Math.round(principal * Math.pow(1 + r, t));
}

export function calcInterestEarned(principal, ratePercent, months) {
  return calcMaturity(principal, ratePercent, months) - principal;
}
